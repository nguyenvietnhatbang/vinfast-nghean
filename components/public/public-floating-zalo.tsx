  ...
  return (
    <>
      <a
        ...
        className="fixed bottom-4 left-4 z-50 flex items-center group cursor-pointer"
      ...
      <a
        ...
        className="fixed bottom-4 right-4 z-50 flex items-center group cursor-pointer"
        aria-label="Mở Zalo"
      >
        <div className="bg-white w-16 h-16 rounded-full flex items-center justify-center shadow-2xl z-10 border border-slate-200 hover:border-slate-300 transition-colors overflow-hidden">
          <img
        ...
        <div className="bg-[#0F172A] text-white font-bold px-5 py-2.5 rounded-r-full -ml-8 pr-8 shadow-xl transform -translate-x-full opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300 ease-out z-0">
          Zalo
        </div>
      </a>
    </>
